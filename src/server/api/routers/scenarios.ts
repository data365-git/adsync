/**
 * Scenarios tRPC router — Phase 2 real-DB implementation.
 *
 * NOTE: `authedProcedure` is provided by Agent A (src/server/api/trpc.ts).
 * It will be unresolved in this worktree until merge. The comment below
 * documents this; merge-time resolver: Agent A adds authedProcedure export.
 * Using publicProcedure as stand-in.
 */
