 ...
 *   rather than synthesizing a transient run. A transient Run with a
 *   synthetic scenarioId would violate Run.scenarioId FK; auto-creating
 *   a stub scenario is silent magic. The UI should guide the user to
